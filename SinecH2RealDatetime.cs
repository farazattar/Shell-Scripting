...
class Program
{
    static void Main()
    {
        // Replace this value with your SINEC time in hex
        string sinecHex = "1E5026A5";

        // Convert hex to uint
        uint sinecTime = Convert.ToUInt32(sinecHex, 16);

        DateTime realDateTime = ConvertSinecToDateTime(sinecTime);

        Console.WriteLine("SINEC Time (Hex): " + sinecHex);
